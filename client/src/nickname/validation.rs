...
const ERR_WHITESPACE: &str =
    "Spaces and line breaks are not allowed";
...
/// Length, emptiness, underscores-only — after charset is known valid.
...
/// While typing: charset always; length / empty / underscores-only only after a submit attempt.
